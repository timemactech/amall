...
public interface ItemAPI {
    ...
    @GetMapping(value = LIST_BY_Order_ID)
    List<ItemVO> listByOrderId(@RequestParam(value = "orderId") @NotNull(message = "{id.notNull}") Long orderId) throws Exception;
}
